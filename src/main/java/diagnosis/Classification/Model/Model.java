...
public class Model extends Layer {
    ...
    public Model(boolean transformations[]) {
        this.flipTransform = transformations[0];
        this.warpTransform = transformations[1];
        this.colorTransform = transformations[2];
    }
...
*/
        List<ImageTransform> transforms = new ArrayList<ImageTransform>();

        if (this.flipTransform) {
            transforms.add(new FlipImageTransform(rng));
            transforms.add(new FlipImageTransform(new Random(123)));
        }

        if (this.warpTransform) {
            transforms.add(new WarpImageTransform(rng, 42));
        }
